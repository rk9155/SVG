...
//     }, [handleMouseMove]);
  ...
  return (
    <div onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onDoubleClick={handleDblClick} style={{width: '100%', height: '100%'}}>
     <svg ref={svgRef} width="100%" height="100%"  onMouseLeave={handleMouseUp}>
        <g>
          <path
